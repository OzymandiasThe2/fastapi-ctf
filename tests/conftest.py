...
# WARNING: Ensure imports from `fastapi_ctf` comes after this line
from fastapi_ctf import app, settings, db  # noqa
from fastapi_ctf.cli import create_user, cli  # noqa
