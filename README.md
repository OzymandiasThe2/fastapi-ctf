...
- 🎯 Entry points to execute your program using `python -m <fastapi_ctf>` or `$ fastapi_ctf` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/OzymandiasThe2/fastapi-ctf/branch/main/graph/badge.svg?token=fastapi-ctf_token_here)](https://codecov.io/gh/OzymandiasThe2/fastapi-ctf)
